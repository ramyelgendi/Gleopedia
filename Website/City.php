...
if($_SERVER["REQUEST_METHOD"] == "GET"){
    if(isset($_GET['id'])){
        $sqltran = mysqli_query($link, "SELECT * FROM City WHERE id = '".$_GET["id"]."'")or die(mysqli_error($link));
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <fieldset disabled>
                                    ...
                                    <div class="form-group">
                                    <label for="disabledTextInput">Governer</label>
                                    <input type="text" id="disabledTextInput" class="form-control" placeholder="<?php echo $rowList['Governer'] ?>">
                                    </div>
                                    <div class="form-group">
                                    <label for="disabledTextInput">Coordinates</label>
                                    <input type="text" id="disabledTextInput" class="form-control" placeholder="<?php echo $rowList['Coordinates'] ?>">
                                    </div>
                                </fieldset>
                                </form>
                                </div>
