                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="" width="100%" cellspacing="0">
                                        ...
                                        Co.President_Monarch, Co.PolCapital, Co.GeoCapital, Co.Continent,
                                        ...
                                        while ($rowList = mysqli_fetch_array($sqltran)) { 
                                            ...
                                            <td><a href="/Country.php?id=<?php echo $current_id ?>"><?php echo $rowList['CountryName'] ?></a></td>
                                                ...
                                                <td><a href="/city.php?id=<?php echo $rowList['GeoCapitalID'] ?>"><?php echo $rowList['GeoCapitalName'] ?></a></td></tr>
